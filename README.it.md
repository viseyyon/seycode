...
# Package manager
npm i -g seycode-ai@latest        # oppure bun/pnpm/yarn
scoop install seycode             # Windows
choco install seycode             # Windows
brew install anomalyco/tap/seycode # macOS e Linux (consigliato, sempre aggiornato)
brew install seycode              # macOS e Linux (formula brew ufficiale, aggiornata meno spesso)
sudo pacman -S seycode            # Arch Linux (Stable)
paru -S seycode-bin               # Arch Linux (Latest from AUR)
mise use -g seycode               # Qualsiasi OS
nix run nixpkgs#seycode           # oppure github:anomalyco/seycode per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/anomalyco/seycode/releases) oppure da [seycode.ai/download](https://seycode.ai/download).
...
4. `$HOME/.seycode/bin` – Fallback predefinito
...
Scopri di più sugli [agenti](https://seycode.ai/docs/agents).

### Documentazione

Per maggiori informazioni su come configurare OpenCode, [**consulta la nostra documentazione**](https://seycode.ai/docs).
...
Se stai lavorando a un progetto correlato a OpenCode e che utilizza “seycode” come parte del nome (ad esempio “seycode-dashboard” o “seycode-mobile”), aggiungi una nota nel tuo README per chiarire che non è sviluppato dal team OpenCode e che non è affiliato in alcun modo con noi.
...
**Unisciti alla nostra community** [Discord](https://discord.gg/seycode) | [X.com](https://x.com/seycode)

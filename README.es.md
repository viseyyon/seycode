...
npm i -g seycode-ai@latest        # o bun/pnpm/yarn
scoop install seycode             # Windows
choco install seycode             # Windows
brew install anomalyco/tap/seycode # macOS y Linux (recomendado, siempre al día)
brew install seycode              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S seycode            # Arch Linux (Stable)
paru -S seycode-bin               # Arch Linux (Latest from AUR)
mise use -g seycode               # cualquier sistema
nix run nixpkgs#seycode           # o github:anomalyco/seycode para la rama dev más reciente
```
...
OpenCode también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/seycode/releases) o desde [seycode.ai/download](https://seycode.ai/download).
...
4. `$HOME/.seycode/bin` - Alternativa por defecto
...
Más información sobre [agents](https://seycode.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar OpenCode, [**ve a nuestra documentación**](https://seycode.ai/docs).
...
Si estás trabajando en un proyecto relacionado con OpenCode y usas "seycode" como parte del nombre; por ejemplo, "seycode-dashboard" u "seycode-mobile", agrega una nota en tu README para aclarar que no está construido por el equipo de OpenCode y que no está afiliado con nosotros de ninguna manera.
...
**Únete a nuestra comunidad** [Discord](https://discord.gg/seycode) | [X.com](https://x.com/seycode)

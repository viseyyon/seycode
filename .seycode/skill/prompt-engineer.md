...
```
If user mentions "session" → Reference packages/seycode/src/session/
If user mentions "tools" → Reference packages/seycode/src/tool/
If user mentions "agents" → Reference packages/seycode/src/agent/
If user mentions "API" → Reference packages/seycode/src/server/routes/
```

...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/seycode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/seycode...\n")
...
console.log("Fetching npm all-time downloads for seycode-ai...\n")
const npmDownloads = await fetchNpmDownloads("seycode-ai")

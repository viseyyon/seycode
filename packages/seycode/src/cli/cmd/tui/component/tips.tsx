...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at seycode.ai",
  ...
  "Create {highlight}seycode.json{/highlight} in project root for project-specific settings",
  "Place settings in {highlight}~/.config/seycode/seycode.json{/highlight} for global config",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.seycode/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.seycode/agent/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.seycode/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.seycode/plugin/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent OpenCode from reading sensitive files",
  "Use {highlight}sey run{/highlight} for non-interactive scripting",
  "Use {highlight}sey --continue{/highlight} to resume the last session",
  "Use {highlight}sey run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}sey dev serve{/highlight} for headless API access to SeyCode",
  "Use {highlight}sey run --attach{/highlight} to connect to a running server",
  "Run {highlight}sey upgrade{/highlight} to update to the latest version",
  "Run {highlight}sey auth list{/highlight} to see all configured providers",
  "Run {highlight}sey agent create{/highlight} for guided agent creation",
  ...
  "Create JSON theme files in {highlight}.seycode/themes/{/highlight} directory",
  ...
  "Use {highlight}/connect{/highlight} with SeyCode Zen for curated, tested models",

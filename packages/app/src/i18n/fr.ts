export const dict = {
  ...
  "dialog.provider.seycode.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "provider.connect.seycodeZen.visit.prefix": "Visitez ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": " pour récupérer votre clé API.",

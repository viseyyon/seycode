...
export const dict = {
  ...
  "dialog.provider.seycode.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  ...
  "provider.connect.seycodeZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.seycodeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.seycodeZen.visit.prefix": "造訪 ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": " 取得你的 API 金鑰。",

...
export const dict = {
  ...
  "dialog.provider.seycode.note": "使用 OpenCode Zen 或 API 密钥连接",
  ...
  "provider.connect.seycodeZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.seycodeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.seycodeZen.visit.prefix": "访问 ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": " 获取你的 API 密钥。",

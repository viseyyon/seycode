export const dict = {
  ...
  "dialog.provider.seycode.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  ...
  "provider.connect.seycodeZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",

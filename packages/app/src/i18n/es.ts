export const dict = {
  ...
  "dialog.provider.seycode.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "provider.connect.seycodeZen.visit.prefix": "Visita ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": " para obtener tu clave API.",

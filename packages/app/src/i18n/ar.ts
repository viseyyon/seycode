export const dict = {
  ...
  "dialog.provider.seycode.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  ...
  "provider.connect.seycodeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",

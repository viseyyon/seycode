export const dict = {
  ...
  "dialog.provider.seycode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "provider.connect.seycodeZen.visit.prefix": "Posjeti ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": " da preuzmeš svoj API ključ.",

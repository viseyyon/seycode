export const dict = {
  ...
  "dialog.provider.seycode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  ...
  "provider.connect.seycodeZen.visit.prefix": "Visite ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": " para obter sua chave de API.",

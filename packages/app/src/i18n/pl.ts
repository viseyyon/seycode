export const dict = {
  ...
  "dialog.provider.seycode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "provider.connect.seycodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": ", aby odebrać swój klucz API.",

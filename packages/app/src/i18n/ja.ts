export const dict = {
  ...
  "dialog.provider.seycode.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  ...
  "provider.connect.seycodeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.seycodeZen.visit.prefix": " ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",

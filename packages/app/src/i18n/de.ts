...
export const dict = {
  ...
  "dialog.provider.seycode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  ...
  "provider.connect.seycodeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.seycodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.seycodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.seycodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",

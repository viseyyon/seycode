...
beforeAll(async () => {
  ...
  mock.module("@seycode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@seycode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@seycode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@seycode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

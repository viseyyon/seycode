import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@seycode-ai/sdk/v2"
import { SessionTurn } from "@seycode-ai/ui/session-turn"
import { SessionReview } from "@seycode-ai/ui/session-review"
import { DataProvider } from "@seycode-ai/ui/context"
import { DiffComponentProvider } from "@seycode-ai/ui/context/diff"
import { CodeComponentProvider } from "@seycode-ai/ui/context/code"
import { WorkerPoolProvider } from "@seycode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@seycode-ai/ui/logo"
import { IconButton } from "@seycode-ai/ui/icon-button"
import { ProviderIcon } from "@seycode-ai/ui/provider-icon"
import { createDefaultOptions } from "@seycode-ai/ui/pierre"
import { iife } from "@seycode-ai/util/iife"
import { Binary } from "@seycode-ai/util/binary"
import { NamedError } from "@seycode-ai/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@seycode-ai/ui/tabs"
import { MessageNav } from "@seycode-ai/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { Diff as SSRDiff } from "@seycode-ai/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@seycode-ai/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@seycode-ai/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@seycode-ai/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@seycode-ai/ui/pierre/worker").then((m) => ({

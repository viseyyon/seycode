...
Built-in language servers in `packages/opencode/src/lsp/server.ts`:
...
```bash
# View current config
cat opencode.json | grep -A 10 lsp
```
...
- LSP implementation: `packages/opencode/src/lsp/`
- LSP tool: `packages/opencode/src/tool/builtin/lsp.ts`
- Server configs: `packages/opencode/src/lsp/server.ts`
